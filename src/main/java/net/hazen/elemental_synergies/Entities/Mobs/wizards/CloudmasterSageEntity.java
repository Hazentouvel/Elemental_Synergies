package net.hazen.elemental_synergies.Entities.Mobs.Wizards;
...
public class CloudmasterSageEntity extends NeutralWizard implements VillagerDataHolder, SupportMob, HomeOwner, IMerchantWizard {
    private static final EntityDataAccessor<VillagerData> DATA_VILLAGER_DATA = SynchedEntityData.defineId(CloudmasterSageEntity.class, EntityDataSerializers.VILLAGER_DATA);
    private static final EntityDataAccessor<Boolean> DATA_VILLAGER_UNHAPPY = SynchedEntityData.defineId(CloudmasterSageEntity.class, EntityDataSerializers.BOOLEAN);
    public GoalSelector supportTargetSelector;
    private int unhappyTimer;

    public CloudmasterSageEntity(EntityType<? extends AbstractSpellCastingMob> pEntityType, Level pLevel) {
    ...
    protected void populateDefaultEquipmentSlots(RandomSource pRandom, DifficultyInstance pDifficulty) {
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ESItemRegistry.CLOUDMASTER_CROWN.get()));
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(ESItemRegistry.CLOUDMASTER_CHESTPLATE.get()));
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(ESItemRegistry.CLOUDMASTER_LEGGINGS.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(ESItemRegistry.CLOUDMASTER_BOOTS.get()));
...
//        }
    ...
    public MerchantOffers getOffers() {
        if (this.offers == null) {
            ...
            this.offers.add(new EndermanTrade().getOffer(this, this.random));
    ...
    static class EndermanTrade extends AdditionalWanderingTrades.SimpleTrade {
        private EndermanTrade() {
            super((trader, random) -> {
                if (!trader.level().isClientSide) {
                    ItemStack cost = new ItemStack(ESItemRegistry.CLOUDMASTER_HAT.get());
                    ItemStack forSale = new ItemStack(ESItemRegistry.CLOUDMASTER_CROWN.get());
