...
public class CloudmasterSageRenderer extends AbstractSpellCastingMobRenderer {

    public CloudmasterSageRenderer(EntityRendererProvider.Context context) {
        super(context, new CloudmasterSageModel());
    }
