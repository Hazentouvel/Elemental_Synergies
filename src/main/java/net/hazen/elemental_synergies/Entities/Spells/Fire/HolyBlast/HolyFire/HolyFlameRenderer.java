...
import net.hazen.hazennstuff.Entity.Spells.Eldritch.SoulSeeker.SoulSeekerModel;
...
public class HolyFlameRenderer extends GeoEntityRenderer<SoulSeeker> {
    public HolyFlameRenderer(EntityRendererProvider.Context context) {
        super(context, new SoulSeekerModel());
    ...
    @Override
    public RenderType getRenderType(SoulSeeker animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
