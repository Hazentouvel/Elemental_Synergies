...
public class BrimflameBolt extends AbstractMagicProjectile {
    public BrimflameBolt(EntityType<? extends BrimflameBolt> entityType, Level level) {
        super(entityType, level);
        this.setNoGravity(true);
    }

    public BrimflameBolt(Level levelIn, LivingEntity shooter) {
        this(ESEntityRegistry.BRIMFLAME_BOLT.get(), levelIn);
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        DamageSource shadowSource = new DamageSource(DamageSources.getHolderFromResource(target, ASDamageTypes.RITUAL_MAGIC));
        DamageSources.applyDamage(target, half, shadowSource);
        DamageSources.applyDamage(target, totalDamage - half, ((AbstractSpell) ESSpellRegistries.BRIMFLAME_BOLT.get()).getDamageSource(this, this.getOwner()));
