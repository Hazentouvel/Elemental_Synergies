...
public class BrimflameBoltRenderer extends EntityRenderer<Projectile> {
    ...
    private static ResourceLocation TEXTURE = ElementalSynergies.id("textures/spells/brimflame_bolt.png");
    private final ModelPart body;

    public BrimflameBoltRenderer(EntityRendererProvider.Context context) {
        super(context);
