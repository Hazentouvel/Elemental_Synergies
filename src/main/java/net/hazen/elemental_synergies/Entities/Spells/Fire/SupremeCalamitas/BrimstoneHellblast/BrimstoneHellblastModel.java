...
public class BrimstoneHellblastModel extends GeoModel<BrimstoneHellblast> {
    ...
    public ResourceLocation getModelResource(BrimstoneHellblast animatable) {
        return ResourceLocation.fromNamespaceAndPath(ElementalSynergies.MOD_ID, "geo/entities/spells/brimstone_hellblast.geo.json");
    }
    ...
    public ResourceLocation getTextureResource(BrimstoneHellblast animatable) {
        ...
        return ResourceLocation.fromNamespaceAndPath(ElementalSynergies.MOD_ID, "textures/spells/brimstone_hellblast_" + frame + ".png");
    }
