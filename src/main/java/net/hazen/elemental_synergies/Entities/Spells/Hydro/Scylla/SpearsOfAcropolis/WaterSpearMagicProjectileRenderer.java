...
@OnlyIn(Dist.CLIENT)
public class WaterSpearMagicProjectileRenderer extends EntityRenderer<WaterSpearMagicProjectile> {
    ...
    public WaterSpearMagicProjectileRenderer(EntityRendererProvider.Context manager) {
        super(manager);
        this.model = new ElementalSpearMagicProjectileModel(manager.bakeLayer(CataclysmModelLayers.ELEMENTAL_SPEAR_MODEL));
    ...
    public void render(WaterSpearMagicProjectile entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    public ResourceLocation getTextureLocation(WaterSpearMagicProjectile entity) {
