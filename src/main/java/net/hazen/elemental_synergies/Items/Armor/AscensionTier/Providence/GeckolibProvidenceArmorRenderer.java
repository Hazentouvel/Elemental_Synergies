...
public class GeckolibProvidenceArmorRenderer extends GeoArmorRenderer<GeckolibProvidenceArmorItem> {
    public GeckolibProvidenceArmorRenderer(GeckolibProvidenceArmorModel ignisArmorModel) {
        super(new GeckolibProvidenceArmorModel());
        this.addRenderLayer(new GeckolibProvidenceArmorLayer(this));
    ...
    public RenderType getRenderType(GeckolibProvidenceArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
