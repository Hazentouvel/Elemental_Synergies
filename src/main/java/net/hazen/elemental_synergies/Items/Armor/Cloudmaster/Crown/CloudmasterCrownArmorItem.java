...
public class CloudmasterCrownArmorItem extends ImbuableESArmorItemGeckolib implements IDisableJacket {
    ...
    public void appendHoverText(@NotNull ItemStack stack,
        ...
        lines.add(Component.translatable("item.elemental_synergies.cloudmaster_crown.description")
                .withStyle(Style.EMPTY.withColor(0xa3b6ff).withItalic(true)));
    }

    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof CloudmasterCrownArmorItem &&
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new CloudmasterCrownArmorModel());
    }
}