...
public class IgnisArmorModel extends DefaultedEntityGeoModel<IgnisArmorItem> {
    public IgnisArmorModel() {
        super(ResourceLocation.fromNamespaceAndPath(ElementalSynergies.MOD_ID, ""));
    }

    // Just replace where the path is with the file path of your texture, EZ PZ
    @Override
    public ResourceLocation getModelResource(IgnisArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(ElementalSynergies.MOD_ID, "geo/armor/ignis_armor.geo.json");
    }
    ...
    @Override
    public ResourceLocation getAnimationResource(IgnisArmorItem animatable) {
