...
public class IgnisArmorRenderer extends GeoArmorRenderer<IgnisArmorItem> {
    public IgnisArmorRenderer(IgnisArmorModel ignisArmorModel) {
        super(new IgnisArmorModel());
        this.addRenderLayer(new IgnisArmorLayer(this));
    ...
    public RenderType getRenderType(IgnisArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
