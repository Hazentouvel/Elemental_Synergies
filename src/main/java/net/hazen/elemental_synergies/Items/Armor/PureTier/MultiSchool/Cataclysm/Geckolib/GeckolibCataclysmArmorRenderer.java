...
public class GeckolibCataclysmArmorRenderer extends GeoArmorRenderer<GeckolibCataclysmArmorItem> {
    public GeckolibCataclysmArmorRenderer(GeckolibCataclysmArmorModel cataclysmArmorModel) {
        super(new GeckolibCataclysmArmorModel());
        this.addRenderLayer(new GeckolibCataclysmArmorLayer(this));
    ...
    public RenderType getRenderType(GeckolibCataclysmArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
