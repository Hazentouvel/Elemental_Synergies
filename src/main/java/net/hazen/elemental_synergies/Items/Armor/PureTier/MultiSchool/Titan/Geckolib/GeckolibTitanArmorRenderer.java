...
public class GeckolibTitanArmorRenderer extends GeoArmorRenderer<GeckolibTitanArmorItem> {
    public GeckolibTitanArmorRenderer(GeckolibTitanArmorModel titanArmorModel) {
        super(new GeckolibTitanArmorModel());
        this.addRenderLayer(new GeckolibTitanArmorLayer(this));
    ...
    public RenderType getRenderType(GeckolibTitanArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
