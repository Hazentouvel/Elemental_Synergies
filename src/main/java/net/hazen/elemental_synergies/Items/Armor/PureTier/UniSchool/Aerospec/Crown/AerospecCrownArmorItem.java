package net.hazen.elemental_synergies.Items.Armor.PureTier.UniSchool.Aerospec.Crown;
...
public class AerospecCrownArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof AerospecCrownArmorItem &&
