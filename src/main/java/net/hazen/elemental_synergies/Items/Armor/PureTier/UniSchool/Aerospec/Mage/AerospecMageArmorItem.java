package net.hazen.elemental_synergies.Items.Armor.PureTier.UniSchool.Aerospec.Mage;
...
public class AerospecMageArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof AerospecMageArmorItem &&
