...
public class GeckolibExoMechArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {
    public GeckolibExoMechArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GeckolibExoMechArmorRenderer(new GeckolibExoMechArmorModel());
    }
}