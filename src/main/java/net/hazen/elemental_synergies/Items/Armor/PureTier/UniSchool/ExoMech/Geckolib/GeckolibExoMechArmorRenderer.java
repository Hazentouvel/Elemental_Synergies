...
public class GeckolibExoMechArmorRenderer extends GeoArmorRenderer<GeckolibExoMechArmorItem> {
    public GeckolibExoMechArmorRenderer(GeckolibExoMechArmorModel exoMechArmorModel) {
        super(new GeckolibExoMechArmorModel());
        this.addRenderLayer(new GeckolibExoMechArmorLayer(this));
    ...
    public RenderType getRenderType(GeckolibExoMechArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
