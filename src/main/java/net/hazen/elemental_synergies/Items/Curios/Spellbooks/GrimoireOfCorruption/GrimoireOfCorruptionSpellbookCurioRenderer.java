...
@OnlyIn(Dist.CLIENT)
public class GrimoireOfCorruptionSpellbookCurioRenderer implements ICurioRenderer {
    private final GrimoireOfCorruptionSpellbookCurioItemRenderer curioRenderer = new GrimoireOfCorruptionSpellbookCurioItemRenderer();
