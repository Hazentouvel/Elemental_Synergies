...
//            )
//            .setComponent(Fire.Component.FLAME_PARTICLE, Objects.requireNonNull(BuiltInRegistries.PARTICLE_TYPE.getKey(ESParticleRegistry.HOLY_EMBER_PARTICLE.get())))
//            .build());
//  }
//
//  private ESFireRegistry() {}
//
