...
public class HolyFlamesEffect extends MagicMobEffect implements ISyncedMobEffect {

    public HolyFlamesEffect(MobEffectCategory mobEffectCategory, int color) {
        super(mobEffectCategory, color);
    }

    @Override
    public boolean applyEffectTick(LivingEntity entity, int amplifier) {
        DamageSource source = entity.damageSources().source(ESDamageTypes.HOLY_BURN);
    ...
    public void clientTick(LivingEntity livingEntity, MobEffectInstance instance) {
        ...
        ParticleOptions particle = ESParticleHelper.HOLY_EMBER_PARTICLE;
