...
public class NightWitherEffect extends MagicMobEffect implements ISyncedMobEffect {
    public static final float DEFENSE_REDUCTION = -0.1F;
    public static final float REDUCTION = -0.05F;

    public NightWitherEffect(MobEffectCategory mobEffectCategory, int color) {
        super(mobEffectCategory, color);
    }

    @Override
    public boolean applyEffectTick(LivingEntity entity, int amplifier) {
        DamageSource source = entity.damageSources().source(ESDamageTypes.NIGHT_WITHER);
    ...
    public void clientTick(LivingEntity livingEntity, MobEffectInstance instance) {
        ...
        ParticleOptions particle = ESParticleHelper.HOLY_NIGHT_EMBER_PARTICLE;
