...
public class ESClientSpellCastHelper {
    ...
    public static void holyFlameExplosion(Vec3 pos, float radius) {
        MinecraftInstanceHelper.ifPlayerPresent((player) -> {
            ...
            double y = pos.y;
            double z = pos.z;
            level.addParticle(new BlastwaveParticleOptions(new Vector3f(1F, 1F, 0.6F), radius + 1.0F), x, y, z, (double)0.0F, (double)0.0F, (double)0.0F);
            ...
            for(int i = 0; i < c; ++i) {
                ...
                level.addParticle(ESParticleHelper.HOLY_EXPLOSION_PARTICLE, x + posOffset.x, y + posOffset.y, z + posOffset.z, vec3.x, vec3.y, vec3.z);
            }
            ...
            for(int i = 0; i < cloudDensity; ++i) {
                ...
                level.addParticle(ESParticleHelper.HOLY_EMBER_PARTICLE, x + posOffset.x, y + posOffset.y, z + posOffset.z, motion.x, motion.y, motion.z);
            }
    ...
    public static void holyNightExplosion(Vec3 pos, float radius) {
        MinecraftInstanceHelper.ifPlayerPresent((player) -> {
            ...
            for(int i = 0; i < c; ++i) {
                ...
                Vec3 posOffset = Utils.getRandomVec3((double)0.5F).add(vec3.scale((double)10.0F));
                vec3 = vec3.add(Utils.getRandomVec3(0.01));
                level.addParticle(ESParticleHelper.HOLY_NIGHT_EXPLOSION_PARTICLE, x + posOffset.x, y + posOffset.y, z + posOffset.z, vec3.x, vec3.y, vec3.z);
            }
            ...
            for(int i = 0; i < cloudDensity; ++i) {
                ...
                posOffset = posOffset.add(motion.scale(Utils.getRandomScaled((double)1.0F)));
                motion = motion.add(Utils.getRandomVec3((double)(speed * 0.1F)));
                level.addParticle(ESParticleHelper.HOLY_NIGHT_EMBER_PARTICLE, x + posOffset.x, y + posOffset.y, z + posOffset.z, motion.x, motion.y, motion.z);
            }
    ...
    public static void brimstoneExplosion(Vec3 pos, float radius) {
        MinecraftInstanceHelper.ifPlayerPresent((player) -> {
            ...
            for(int i = 0; i < c; ++i) {
                ...
                Vec3 posOffset = Utils.getRandomVec3((double)0.5F).add(vec3.scale((double)10.0F));
                vec3 = vec3.add(Utils.getRandomVec3(0.01));
                level.addParticle(ESParticleHelper.BRIMSTONE_EXPLOSION_PARTICLE, x + posOffset.x, y + posOffset.y, z + posOffset.z, vec3.x, vec3.y, vec3.z);
            }
    ...
    public static void soulFlameExplosion(Vec3 pos, float radius) {
        MinecraftInstanceHelper.ifPlayerPresent((player) -> {
            Level level = player.level;
            double x = pos.x;
            double y = pos.y;
            ...
            for(int i = 0; i < c; ++i) {
                ...
                Vec3 posOffset = Utils.getRandomVec3((double)0.5F).add(vec3.scale((double)10.0F));
                vec3 = vec3.add(Utils.getRandomVec3(0.01));
                level.addParticle(ESParticleHelper.SOUL_FLAME_EXPLOSION_PARTICLE, x + posOffset.x, y + posOffset.y, z + posOffset.z, vec3.x, vec3.y, vec3.z);
            }
            ...
            for(int i = 0; i < cloudDensity; ++i) {
                ...
                posOffset = posOffset.add(motion.scale(Utils.getRandomScaled((double)1.0F)));
                motion = motion.add(Utils.getRandomVec3((double)(speed * 0.1F)));
                level.addParticle(ParticleTypes.SOUL_FIRE_FLAME, x + posOffset.x, y + posOffset.y, z + posOffset.z, motion.x, motion.y, motion.z);
            }
            ...
            for(int i = 0; i < cloudDensity; i += 2) {
                ...
                Vec3 motion = posOffset.normalize().scale((double)(speed * 0.5F));
                motion = motion.add(Utils.getRandomVec3((double)0.25F));
                level.addParticle(ParticleTypes.SOUL_FIRE_FLAME, true, x + posOffset.x, y + posOffset.y, z + posOffset.z, motion.x, motion.y, motion.z);
                level.addParticle(ParticleTypes.SOUL_FIRE_FLAME, x + posOffset.x * (double)0.5F, y + posOffset.y * (double)0.5F, z + posOffset.z * (double)0.5F, motion.x, motion.y, motion.z);
            }
