    ...
    public static void handleClientboundHolyFlameExplosion(Vec3 pos, float radius) {
        MinecraftInstanceHelper.ifPlayerPresent((player) -> {
            ...
            for(int i = 0; i < c; ++i) {
                ...
                level.addParticle(ESParticleHelper.HOLY_EMBER_PARTICLE, x + posOffset.x, y + posOffset.y, z + posOffset.z, vec3.x, vec3.y, vec3.z);
            }
    ...
    public static void handleClientboundHolyNightFlameExplosion(Vec3 pos, float radius) {
        MinecraftInstanceHelper.ifPlayerPresent((player) -> {
            ...
            for(int i = 0; i < c; ++i) {
                ...
                Vec3 posOffset = Utils.getRandomVec3((double)0.5F).add(vec3.scale((double)10.0F));
                vec3 = vec3.add(Utils.getRandomVec3(0.01));
                level.addParticle(ESParticleHelper.HOLY_NIGHT_EMBER_PARTICLE, x + posOffset.x, y + posOffset.y, z + posOffset.z, vec3.x, vec3.y, vec3.z);
            }
