package net.hazen.elemental_synergies.Spells.Schools.Fire.ProvidenceSpells;
...
public class HolyBlastSpell extends CalamitasSpells {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(ElementalSynergies.MOD_ID, "brimstone_hellblast");
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        // set spell level so the projectile can scale spawned flames
    ...
    public float getDamage(int spellLevel, LivingEntity caster) {
        ...
        return (float)(5 + 5.0 * getSpellPower(spellLevel, caster) * ((0.5 * firePower ) + (0.5 * holyPower)));
    }
