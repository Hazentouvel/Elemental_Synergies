...
public class ImbuableESArmorItem extends ESArmorItem implements IPresetSpellContainer {
    public ImbuableESArmorItem(Holder<ArmorMaterial> material, ArmorItem.Type type, Item.Properties properties, AttributeContainer... attributeContainers) {
